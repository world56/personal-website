...
const PostTools: React.FC<TypePostToolsProps> = ({ date, title }) => {
  ...
  return (
    <div className="flex justify-between items-center pb-5 mb-6 text-gray-400 border-b border-grey-100 h-[41px]">
      <time dateTime={time} className="flex items-center text-sm">
